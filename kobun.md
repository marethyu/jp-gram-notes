...
|-|-|
|基本形|元となる形。終止形と同じ。|
|未然形|「まだそうなっていない」の形。「書く」の場合は「**書か**ず」。|
|連用形|主として用言に続くときの形。「書く」の場合は「**書き**たり」。|
|終止形|文の終わりに用いられる形。「書く」の場合はそのまま。|
|連体形|体言に続くときの形。「書く」の場合は「**書く**とき」。|
|已然形|「(仮に)もうそうなっている」の形。「書く」の場合は「**書け**ども」。|
|命令形|命令するときの形。「書く」の場合は「書け」。|
